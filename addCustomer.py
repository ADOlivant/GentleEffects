...
class AddCustomer(QMainWindow):
	...
	def __init__(self):
		...
		self.contact_layout.addWidget(self.mobile_label,0,0)
		self.contact_layout.addWidget(self.mobile_lineedit,0,1)
		self.contact_layout.addWidget(self.home_label,1,0)
		self.contact_layout.addWidget(self.home_lineedit,1,1)
		self.contact_layout.addWidget(self.preferred_groupbox,2,1)
		self.contact_layout.addWidget(self.email_label,3,0)
		self.contact_layout.addWidget(self.email_lineedit,3,1)
		...
		self.data_layout.addWidget(self.name_widget,0,0)
		self.data_layout.addWidget(self.contact_widget,0,1)
		#self.data_layout.addWidget(self.dateofbirth_widget,1,0)
		self.data_layout.addWidget(self.address_widget,2,0)
		self.data_layout.addWidget(self.button_widget)
